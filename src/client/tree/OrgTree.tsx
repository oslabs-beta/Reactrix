...
export const OrgTreeComponent = forwardRef<any, IOrgTreeProps>(({ data, onClick, collapsable = true, expandAll = true, horizontal = false, ...props }, ref) => {
  ...
  return (
    <HierarchyContextProvider treeRef={ref} onExpandNodes={onExpandNodes} data={data}>
      <OrgTreeContainer horizontal={horizontal}>
        <OrgTree horizontal={horizontal}>
          <TreeNode horizontal={horizontal} node={node} collapsable={collapsable} expandAll={expandAllNodes} onClick={(e, nodeData) => onClick && onClick(e, nodeData)} {...props} />
        </OrgTree>
      </OrgTreeContainer>
