    ...
    >
      ...
      <TreeItem nodeId='3' label='Project 3'>
        <FormControlLabel
          ...
          control={<Checkbox />}
          onClick={handleCheck}
          label='10/23/2021 Snapshot 2'
        />
        <FormControlLabel
          value='start'
          control={<Checkbox />}
          onClick={handleCheck}
          label='10/22/2021 Snapshot 1'
        />
      </TreeItem>
      <TreeItem nodeId='4' label='Project 4'>
        <FormControlLabel
          ...
          control={<Checkbox />}
          onClick={handleCheck}
          label='10/03/2021 Snapshot 2'
        />
        <FormControlLabel
          value='start'
          control={<Checkbox />}
          onClick={handleCheck}
          label='09/18/2021 Snapshot 1'
        />
      </TreeItem>
    </TreeView>
  );
